...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  setTerminalGlass: (windowId, enable, color) => ipcRenderer.invoke('set-terminal-glass', windowId, enable, color),
  setTerminalGlassBatch: (windowIds, enable, color) => ipcRenderer.invoke('set-terminal-glass-batch', windowIds, enable, color),
  clearTerminalGlassState: (windowIds) => ipcRenderer.invoke('clear-terminal-glass-state', windowIds),
